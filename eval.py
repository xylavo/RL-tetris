...
if __name__ == "__main__":
    ...
    dqn_agent.board_cnn.load_state_dict(torch.load("dqn_agent_latest_board_62000.pth"))
    dqn_agent.next_block_mlp.load_state_dict(torch.load("dqn_agent_latest_next_block_62000.pth"))
    dqn_agent.fc.load_state_dict(torch.load("dqn_agent_latest_fc_62000.pth"))
    state = env.reset()
